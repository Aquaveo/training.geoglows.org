...
Puedes añadirlo a mapas web como una capa web sin necesidad de descargar los datos adicionales ni la red de drenaje. Si estás intentando descargar el *hydrofabric*, encontrarás instrucciones sobre cómo hacerlo en la sección de [datos disponibles](../../datasets/catalog).
