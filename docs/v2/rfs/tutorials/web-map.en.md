...
You can add it to web maps as a web layer without needing to download the additional data or stream network. If you are trying to download the hydrofabric, there are instructions about that in the [available data](../datasets/catalog.md) section.
